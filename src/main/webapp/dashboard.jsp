...
<!-- 					</div> -->
		...
		<div class="footer">
			<div class="footer-inner">
				<div class="footer-content">
					<span class="bigger-120"> Copyright &copy; 2000-2015 <span class="blue bolder">XINHUANET.com</span>
					</span>
				</div>
			</div>
		</div>
	...
	<!--[if !IE]> -->
	<script src="commons/js/jquery-2.1.3.min.js"></script>
	<!-- <![endif]-->

	<!--[if IE]>
	<script src="commons/js/jquery-1.11.2.min.js"></script>
	<![endif]-->
